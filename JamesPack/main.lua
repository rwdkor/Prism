...
Game.Settings.settings_draw_fov = false --fov 표시 끄기
Game.Settings.settings_esp_text = false --영웅이름 표시 끄기
Game.Settings.settings_esp_skeleton = true --스켈레톤 esp 끄기
Game.Settings.settings_esp_skeleton_useraycast = false --스켈레톤 esp 뼉구분 끄기
Game.Settings.settings_esp_highlight = false --테월 끄기
